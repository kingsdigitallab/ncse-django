...
class ArticleIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    publication_url = indexes.CharField(indexed=False)
    publication_abbreviation = indexes.FacetCharField(
        model_attr='issue__publication__abbreviation')
    ...
    publication_title = indexes.FacetCharField(
        model_attr='issue__publication__title')
    publication_description = indexes.CharField(
        model_attr='issue__publication__description')
